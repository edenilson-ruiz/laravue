...
export const constantRoutes = [
  ...
  },
  {
    path: '/planillas',
    component: Layout,
    redirect: '/planillas/pospago/masivo',
    name: 'planillas',
    meta: {
      title: 'planillas',
      icon: 'form',
    ...
    children: [
      {
        path: 'pospago/masivo', // When clicking this submenu, it will redirect to /#/foo/index
        component: () => import('@/views/planillas/pospago/List.vue'),
        name: 'PospagoMasivo',
        meta: { title: 'pospagoMasivo', icon: 'table' }, // foo submenu
      },
      {
        path: 'multimedia/masivo', // When clicking this submenu, it will redirect to /#/foo/multimedia
        component: () => import('@/views/planillas/multimedia/List.vue'),
        name: 'MultimediaMasivo',
        meta: { title: 'multimediaMasivo', icon: 'tab' }, // bar submenu
      },
    ],
  },
  {
